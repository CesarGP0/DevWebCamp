<footer class="footer">
    <div class="footer__grid">
        <div class="footer__contenido">
            ...
            <p class="footer__texto">
                DevWebCamp es una conferencia para desarrolladores de todos los niveles, se lleva acabo en presencial y en línea.
            </p>
        </div>
    ...
    <p class="footer__copyright">
        ...
        <span class="footer__copyright--regular">
            - Todos lo derechos reservados <?php echo date('Y'); ?>
        </span>
    </p>
</footer>